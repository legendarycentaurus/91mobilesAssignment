...
<link
 ...
 <script src="${pageContext.request.contextPath}/resources/js/afterLoginApp.js"></script> 
  <script src="${pageContext.request.contextPath}/resources/js/homeController.js"></script> 
  <script src="${pageContext.request.contextPath}/resources/js/cartController.js"></script>
   <script src="${pageContext.request.contextPath}/resources/js/orderController.js"></script> 
</head>
